...
export const FeatureInstantServerStart = () => {
  ...
  return (
    <div ref={cardRef as React.RefObject<HTMLElement>} id="instant-server-start-card" className='feature-card' onMouseOver={startAnimation}>
      ...
      <div className="feature__meta">
        <div className="meta__title">Instant server start</div>
