...
export const FeatureCI = () => {
  ...
  return (
    ...
    >
      <div className={`feature__visualization ${isCardActive ? 'acitve' : ''}`}>
        <div className="camera-container">
          ...
          <span className="ci-text">CI Tests</span>
          ...
          >
            <SvgNode
              ...
              position={glowPosition.current}
              visible={glowVisible.current}
              dot-color={false}
              glow-color="#13B351"
            />
            <SvgNode
            ...
            <SvgNode
              ...
              position={1 - glowPosition.current}
              visible={glowVisible.current}
              dot-color={false}
              glow-color="#13B351"
            />
